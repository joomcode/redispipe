	...
	expectedSlots := []SlotsRange{
		{
			...
			AddrHostnames: map[string]string{
				"127.0.0.1:30001": "host-1.redis.example.com:30001",
				"127.0.0.1:30004": "host-2.redis.example.com:30004",
			},
		},
		{
			From: 5461,
			...
			AddrHostnames: map[string]string{
				"127.0.0.1:30002": "host-3.redis.example.com:30002",
				"127.0.0.1:30005": "host-4.redis.example.com:30005",
			},
		},
		{
			From: 10923,
			...
			AddrHostnames: map[string]string{
				"192.168.11.131:30003": "host-5.redis.example.com:30003",
				"127.0.0.1:30006":      "host-6.redis.example.com:30006",
			},
		},
	}
...
func TestParseSlotsInfo_NoHostname(t *testing.T) {
	clusterSlotsResponse := []interface{}{
		[]interface{}{
			int64(0),
			int64(5460),
